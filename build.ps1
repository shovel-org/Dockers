...
##servercore
docker build --build-arg 'IMAGE=powershell' --build-arg 'VERSION=windowsservercore-2004' --build-arg 'POWERSHELL=pwsh.exe' --tag 'shovelinstaller/shovel:windowsservercore' --tag 'shovelinstaller/shovel:windowsservercore-2004' --no-cache -f .\windows\Dockerfile .
